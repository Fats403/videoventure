...
2. Analyze the concept and determine the appropriate number of scenes needed (minimum 2, maximum ${maxScenes}).
3. Select ONE consistent visual style for the entire video.
...
5. Also generate 3-5 relevant tags that describe the content and style of the video.
        ...
        try {
          const response = await this.openai.chat.completions.create({
            ...
            messages: [
              ...
              {
                role: "user",
                content: `Create a video storyboard with at least ${Math.min(
                  2,
                  maxScenes
                )} scenes based on this concept: "${inputConcept}". Remember to format your response as a JSON object with a "title" string, "visual_style" string, "tags" array, and a "scenes" array containing all scene objects.`,
              },
            ],
